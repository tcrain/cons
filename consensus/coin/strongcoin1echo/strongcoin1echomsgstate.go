...
type roundInfo struct {
	shouldSendCoin bool // set to true once n-t pre coin messages have benn received
	gotCoin        bool
	coinVal        types.BinVal
	sentPreCoin    bool // set to true once the coin broadcast has been sent
	sentCoin       bool
}
...
// StrongCoin1EchoMsgState represents the state of messages implementing a strong coin
...
// NewStrongCoin1EchoMsgState generates a new StrongCoin1EchoMsgState object.
func NewStrongCoin1EchoMsgState(isMv bool,
...
// New creates a new empty StrongCoin1EchoMsgState object for the consensus index idx.
...
func (sms *MsgState) GotMsg(msgState consinterface.MessageState, deser *channelinterface.DeserializedItem,
	...
	case *messagetypes.CoinPreMessage:
		...
		if deser.NewMsgIDSigCount >= nmt {
			roundStruct.shouldSendCoin = true
		}
