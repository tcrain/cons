...
// StrongCoin1Echo represents a strong coin implemented by an n-t threshold signautre.
type StrongCoin1Echo struct {
}

func NewStrongCoin1Echo() consinterface.CoinItemInterface {
	return &StrongCoin1Echo{}
}

func (sc1 *StrongCoin1Echo) GenerateCoinMessage(round types.ConsensusRound, alwaysGenerate bool, consItem consinterface.ConsItem,
...
func (sc1 *StrongCoin1Echo) CheckCoinMessage(deser *channelinterface.DeserializedItem,
...
func (StrongCoin1Echo) GetHeader(emptyPub sig.Pub, gc *generalconfig.GeneralConfig,
...
func (StrongCoin1Echo) GetBufferCount(hdr messages.MsgIDHeader, gc *generalconfig.GeneralConfig,
