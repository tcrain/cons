...
func (sc1 *KnownCoin) GenerateCoinMessage(types.ConsensusRound, bool, consinterface.ConsItem,
...
func (KnownCoin) GetHeader(sig.Pub, *generalconfig.GeneralConfig,
...
func (KnownCoin) GetBufferCount(messages.MsgIDHeader, *generalconfig.GeneralConfig,
