...
// StrongCoin1 represents a strong coin implemented by an n-t (or t+1) threshold signautre.
type StrongCoin1 struct {
}

func NewStrongCoin1() consinterface.CoinItemInterface {
	return &StrongCoin1{}
}

func (sc1 *StrongCoin1) GenerateCoinMessage(round types.ConsensusRound, alwaysGenerate bool, consItem consinterface.ConsItem,
...
func (*StrongCoin1) CheckCoinMessage(deser *channelinterface.DeserializedItem,
...
func (StrongCoin1) GetHeader(emptyPub sig.Pub, _ *generalconfig.GeneralConfig,
...
func (StrongCoin1) GetBufferCount(hdr messages.MsgIDHeader, gc *generalconfig.GeneralConfig,
