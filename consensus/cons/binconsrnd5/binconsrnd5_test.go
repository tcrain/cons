...
func TestBinConsRnd5Basic(t *testing.T) {
	cons.RunBasicTests(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5BasicCoinDual(t *testing.T) {
	cons.RunBasicTests(binTODual, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5BasicStrongCoin2(t *testing.T) {
	cons.RunBasicTests(binTOStrongCoin2, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5BasicStrongCoin2Echo(t *testing.T) {
	cons.RunBasicTests(binTOStrongCoin2Echo, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5BasicStrongCoin1Echo(t *testing.T) {
	cons.RunBasicTests(binTOStrongCoin1Echo, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5Byz(t *testing.T) {
	cons.RunByzTests(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}

func TestBinConsRnd5MemStore(t *testing.T) {
	cons.RunMemstoreTest(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, nil, t)
}

func TestBinConsRnd5MsgDrop(t *testing.T) {
	cons.RunMsgDropTest(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, nil, t)
}

func TestBinConsRnd5P2p(t *testing.T) {
	cons.RunP2pNwTests(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, nil, t)
}

func TestBinConsRnd5FailDisk(t *testing.T) {
	cons.RunFailureTests(binTO, types.BinConsRnd5Type, &BinConsRnd5{},
		Config{}, []int{}, t)
}
